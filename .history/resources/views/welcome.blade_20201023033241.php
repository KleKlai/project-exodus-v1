        ...
        <div class="nav-container">
            ...
            <div id="captioned-gallery">
                <figure class="slider row">
                    <figure class="col-md">
                        <img src="{{ asset('/images/covers/cover1.png') }}" class="img-fluid" alt>
                    </figure>
                    <figure class="col-md">
                        <img src="{{ asset('/images/covers/cover2.png') }}" class="img-fluid" alt>
                    </figure>
                    <figure class="col-md">
                        <img src="{{ asset('/images/covers/cover3.png') }}" class="img-fluid" alt>
                    </figure>
                    <figure class="col-md">
                        <img src="{{ asset('/images/covers/cover4.png') }}" class="img-fluid" alt>
                    </figure>
                    <figure class="col-md">
                        <img src="{{ asset('/images/covers/cover5.png') }}" class="img-fluid" alt>
                    </figure>
                </figure>
            </div>
