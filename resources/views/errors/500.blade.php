            ...
            <div class="row">   
                <div class="col-sm-12 ">
                    <div class="col-sm-10 col-sm-offset-1  text-center">
                        ...
                        <img src="{{ asset('images/assets/500.svg') }}" alt="No Result Found" width="300" class="mx-auto d-block">
                        
                        <div class="mt-3">
                            <h3 class="h2">
                            Looks like we have server error
                            </h3>
                            <p>Check us again later or you can go back to home for now.</p>
