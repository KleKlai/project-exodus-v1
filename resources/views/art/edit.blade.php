            ...
            <div class="row">
                <div class="col-7">
                    ...
                    <div class="form-group col-md-6">
                        <div class="mt-2" id="submitButton">
                            <a href="{{ url()->previous() }}" class="btn border-none">Cancel</a>
                            <button type="submit" onclick="buttonClicked()" class="btn btn-primary">Save</button>
                        </div>
                ...
                <div class="col-5">
                    <h4 class="">Preview</h4>
                    <img class="picture" id="imageView" src="{{ url('storage/artwork/'.$art->attachment) }}" alt="Artwork {{ $art->attachment }}" height="300px">
                </div>
            </div>
